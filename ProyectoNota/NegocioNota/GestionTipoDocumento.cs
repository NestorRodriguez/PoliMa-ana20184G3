namespace NegocioNota
{
    ...
    public class GestionTipoDocumento : ICrud
    {
        /// <summary>
        ...
        {
            var tipoDocumento = (TipoDocumentoDto)_objectoActualizar;

            //using (ContextoNota db = new ContextoNota())
            //{
            //    db.Entry(new TipoDocumento
            //    {
            //        IdTipoDocumento = tipoDocumento.IdTipoDocumento,
            //        Descripcion = tipoDocumento.Descripcion
            //    }).State = EntityModel.Modifie;

            //    return db.SaveChageAsync() > 0 ? true : false;
            //}
        ...
        /// </summary>
        /// <returns>Retonar el objeto obtenido en este caso de tipo TipoDocumentoDto</returns>
        ...
        /// </summary>
        /// <returns>Retornar una lista de objetos en este caso una lista de TipoDocumentoDto</returns>
