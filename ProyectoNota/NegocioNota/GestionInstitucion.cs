namespace NegocioNota
{
    ...
    public class GestionInstitucion : ICrud
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Retonar el objeto obtenido en este caso de tipo InstitucionDto</returns>
        ...
        /// </summary>
        /// <returns>Retornar una lista de objetos en este caso una lista de InstitucionDto</returns>
